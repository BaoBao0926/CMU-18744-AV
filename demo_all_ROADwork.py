...
# --- Config (globals) ---
DEFAULT_SOURCE = os.path.join("Datasets", "ROADwork", "images")
OUTPUT_ROOT = os.path.join("output", "ROADwork")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--source", type=str, default=DEFAULT_SOURCE, help="Image/video file or folder")
